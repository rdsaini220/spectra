...
const FeaturesTab = () => {
  ...
  return (
    <>
      {/* <!-- ===== Features Tab Start ===== --> */}
      <section className="relative pb-20 pt-18.5 lg:pb-22.5" id={'Usecases'}>
              ...
              featuresTabData.map((feature, key) => {
                 return (
                    <div
                      ...
                      className={`relative flex w-full cursor-pointer items-center gap-4 border-b border-stroke px-6 py-2 last:border-0 dark:border-strokedark md:w-auto md:border-0 xl:px-9 xl:py-5 ${
